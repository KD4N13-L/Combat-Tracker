...
g["ghoul"] = {"name": "Ghoul", "dexterity": "2"}
...
g["gnoll"] = {"name": "Gnoll", "dexterity": "1"}
...
g["goblin"] = {"name": "Goblin", "dexterity": "2"}
...
g["grick"] = {"name": "Grick", "dexterity": "2"}
...
h["hobgoblin"] = {"name": "Hobgoblin", "dexterity": "1"}
...
l["lizardfolk"] = {"name": "Lizardfolk", "dexterity": "0"}
...
m["mummy"] = {"name": "Mummy", "dexterity": "-1"}
...
r["remorhaz"] = {"name": "Remorhaz", "dexterity": "1"}
...
s["sahuagin"] = {"name": "Sahuagin", "dexterity": "0"}
...
s["salamander"] = {"name": "Salamander", "dexterity": "2"}
...
s["skeleton"] = {"name": "Skeleton", "dexterity": "2"}
...
v["vampire"] = {"name": "Vampire", "dexterity": "4"}
...
z["zombie"] = {"name": "Zombie", "dexterity": "-2"}
...
with open("Monter stats/a.json", "w") as file:
    json.dump(a, file, sort_keys=True, indent=2)
with open("Monter stats/b.json", "w") as file:
    json.dump(b, file, sort_keys=True, indent=2)
with open("Monter stats/c.json", "w") as file:
    json.dump(c, file, sort_keys=True, indent=2)
with open("Monter stats/d.json", "w") as file:
    json.dump(d, file, sort_keys=True, indent=2)
with open("Monter stats/e.json", "w") as file:
    json.dump(e, file, sort_keys=True, indent=2)
with open("Monter stats/f.json", "w") as file:
    json.dump(f, file, sort_keys=True, indent=2)
with open("Monter stats/g.json", "w") as file:
    json.dump(g, file, sort_keys=True, indent=2)
with open("Monter stats/h.json", "w") as file:
    json.dump(h, file, sort_keys=True, indent=2)
with open("Monter stats/i.json", "w") as file:
    json.dump(i, file, sort_keys=True, indent=2)
with open("Monter stats/j.json", "w") as file:
    json.dump(j, file, sort_keys=True, indent=2)
with open("Monter stats/k.json", "w") as file:
    json.dump(k, file, sort_keys=True, indent=2)
with open("Monter stats/l.json", "w") as file:
    json.dump(l, file, sort_keys=True, indent=2)
with open("Monter stats/m.json", "w") as file:
    json.dump(m, file, sort_keys=True, indent=2)
with open("Monter stats/n.json", "w") as file:
    json.dump(n, file, sort_keys=True, indent=2)
with open("Monter stats/o.json", "w") as file:
    json.dump(o, file, sort_keys=True, indent=2)
with open("Monter stats/p.json", "w") as file:
    json.dump(p, file, sort_keys=True, indent=2)
with open("Monter stats/q.json", "w") as file:
    json.dump(q, file, sort_keys=True, indent=2)
with open("Monter stats/r.json", "w") as file:
    json.dump(r, file, sort_keys=True, indent=2)
with open("Monter stats/s.json", "w") as file:
    json.dump(s, file, sort_keys=True, indent=2)
with open("Monter stats/t.json", "w") as file:
    json.dump(t, file, sort_keys=True, indent=2)
with open("Monter stats/u.json", "w") as file:
    json.dump(u, file, sort_keys=True, indent=2)
with open("Monter stats/v.json", "w") as file:
    json.dump(v, file, sort_keys=True, indent=2)
with open("Monter stats/w.json", "w") as file:
    json.dump(w, file, sort_keys=True, indent=2)
with open("Monter stats/x.json", "w") as file:
    json.dump(x, file, sort_keys=True, indent=2)
with open("Monter stats/y.json", "w") as file:
    json.dump(y, file, sort_keys=True, indent=2)
with open("Monter stats/z.json", "w") as file:
    json.dump(z, file, sort_keys=True, indent=2)
with open("Monter stats/misc_creatures.json", "w") as file:
    json.dump(misc_creatures, file, sort_keys=True, indent=2)
with open("Monter stats/npcs.json", "w") as file:
